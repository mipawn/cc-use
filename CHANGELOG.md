...
- 供应商和密钥卡新增多折线用量趋势，支持近 7 天、近 30 天、近一年、本月、上月、本年和按天自定义日期范围
- 线路摘要新增平均首 Token 时间，供应商级汇总全部密钥，密钥级保持独立归因
- 自定义日期范围新增“今天”快捷项，日期组件随全局语言切换月份、星期和操作文案
...
- 趋势图最多渲染 400 个均匀抽样的自然日，统计汇总仍使用完整范围，避免长期数据导致界面内存膨胀
- 供应商 / 密钥用量弹窗使用紧凑时间标签与摘要指标，提升有限宽度内的信息密度
- 补充竞品能力审视，后续优先考虑全局多维筛选、只读托盘额度和显式 User-Agent 覆盖

### Removed

- 全局用量统计移除“每日使用趋势”和“失败明细”，保留 Token 构成、Key / 项目归因、摘要及最近请求记录
