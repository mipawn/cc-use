export default {
  ...
  settings: {
    ...
    closeToTrayDesc:
      "Minimize to system tray when closing window, proxy keeps running",
    ...
    installerOpened:
      "Installer opened, please follow the prompts to complete installation",
  ...
  dashboard: {
    ...
    dropZoneHint:
      "The folder will be opened in a terminal with the configured environment",
  ...
  providers: {
    ...
    jsonPlaceholder:
      "Paste JSON configuration, supports single object or array for batch import",
    ...
    newapiUserIdPlaceholder:
      "Find in NewAPI dashboard personal settings, e.g. 1",
  ...
  projects: {
    ...
    dropFolderHint:
      "Drop a folder on the Dashboard to create your first project",
    deleteProject: "Delete this project?",
    deleteProjectHint:
      "This will only remove the project from the list, not delete any files.",
    ...
    keyNotCompatibleHint:
      "Key does not support current CLI type, please switch key or type",
  },
  newProject: {
    title: "New Project",
    enterName: "Please enter project name",
    ...
    bindingHint:
      "Without binding, the default API key configuration will be used",
  },
  dropZone: {
  ...
  apiKeys: {
    ...
    jsonEditHint:
      "Changes in JSON will override global config, only differences are saved",
  ...
  keys: {
    ...
    usagePathHint:
      "JSON path to extract quota value, e.g. data.total_available",
  ...
  statistics: {
    ...
    noData: "No Data",
    noDataHint:
      "Send API requests through the proxy to see cost statistics here",
  },
  globalConfig: {
