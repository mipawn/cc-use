export default {
  ...
  console: {
    ...
    viewLogs: 'Runtime logs',
    searchPlaceholder: 'Search model, key, error…',
    more: 'More',
    summary: 'Summary',
    upstream: 'Upstream',
    wsUpgraded:
      'Connection upgraded — the proxy connected, which is not a completed model generation',
    detailNotCaptured: 'Detail capture was off for this request',
    copyRequestId: 'Copy request id',
    noProblems: 'No problems',
    newEvents: '{{count}} new · jump to latest',
    detailModeHint:
      'Whether the console stores request/response detail. Separate from opening a detail view.',
  ...
  statistics: {
    ...
    autoAuditOriginalModel: 'original',
    autoAuditThinking: 'Thinking',
    autoAuditVerdict: 'Model answer',
    autoAuditState: 'Request state',
    autoAuditClient: 'Client execution',
    autoAuditNotObserved: 'Not observed',
    autoAuditRequestId: 'Request id',
    autoAuditStop: 'Stop reason',
    autoAuditSession: 'Session',
    autoAuditTool: 'Tool',
    autoAuditEmpty: 'No records yet',
    autoAuditLoadFailed: 'Failed to load Auto records',
    verdictBlock: 'Blocked',
    verdictNoBlock: 'Not blocked',
